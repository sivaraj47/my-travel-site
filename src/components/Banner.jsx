...
<feGaussianBlur stdDeviation="98.6172" result="effect1_foregroundBlur_4687_3057"/>
            ...
            <div class="col-md-7 col-12 position-relative mt-5 mt-md-0">
                <img class="img-fluid" src="https://i.postimg.cc/SNw8yFC1/Group-1000001855.png">
                    <button class="toplace"><svg width="18" height="20" class="m-1" viewBox="0 0 18 20"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M0.523254 8.41348C0.523254 3.87717 4.31398 0.210693 8.89921 0.210693C13.4974 0.210693 17.2882
                            3.87717 17.2882 8.41348C17.2882 10.6993 16.4568 12.8215 15.0885 14.6202C13.579 16.6043 
                            11.7185 18.3331 9.62415 19.69C9.14487 20.0036 8.71233 20.0272 8.18621 19.69C6.08008 
                            18.3331 4.21952 16.6043 2.72291 14.6202C1.35359 12.8215 0.523254 10.6993 0.523254 
                            8.41348ZM6.13875 8.6689C6.13875 10.1885 7.37883 11.3837 8.89921 11.3837C10.4207 11.3837
                            11.6727 10.1885 11.6727 8.6689C11.6727 7.16104 10.4207 5.90764 8.89921 5.90764C7.37883 
                            5.90764 6.13875 7.16104 6.13875 8.6689Z" fill="#FACD49"></path>
                    </svg>Top Place</button><button class="tophotel">
                        <svg width="18" height="20" class="m-1" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.523254 8.41348C0.523254 3.87717 4.31398 0.210693 8.89921 0.210693C13.4974 0.210693 17.2882 3.87717 17.2882 8.41348C17.2882 10.6993 16.4568 12.8215 15.0885 14.6202C13.579 16.6043 11.7185 18.3331 9.62415 19.69C9.14487 20.0036 8.71233 20.0272 8.18621 19.69C6.08008 18.3331 4.21952 16.6043 2.72291 14.6202C1.35359 12.8215 0.523254 10.6993 0.523254 8.41348ZM6.13875 8.6689C6.13875 10.1885 7.37883 11.3837 8.89921 11.3837C10.4207 11.3837 11.6727 10.1885 11.6727 8.6689C11.6727 7.16104 10.4207 5.90764 8.89921 5.90764C7.37883 5.90764 6.13875 7.16104 6.13875 8.6689Z" fill="#FACD49"></path></svg>Top Hotel</button><img class="travlimg " src="https://i.postimg.cc/Njq4drJ0/menina-de-cabelos-escuros-com-oculos-e-chapeu-de-palha-detem-ingressos-e-mala-azul-retrato-de-viajan.png"></div>
